...
def parse_args(args, parser):
    ...
    parser.add_argument('--invariant_type', type=str, default = "attn_sum", choices = ["attn_sum", "split_attn", "mean", "alter_attn", "attn_rnn", "attn_N", "hama"])
    ...
    # dgn
    parser.add_argument('--dgn', default=False, action='store_true')
    parser.add_argument('--dgn_lambda', default=0.03)
